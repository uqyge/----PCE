function [nod_now]=Disposal_grid2(nnode,nod,m,n,nelem_spring,nelem_bar,nelem_cable,cluster,ele_spring,ele_bar,ele_cable,ele_cluster,dis1)
  ...
  %============================= plot springs ==================================
        ...
        for ie=1:nelem_cable
            ...
            if(fal==2)
                ...
                if ismember(ie,[])
                plot3([xxi,xxj],[yyi,yyj],[zzi,zzj],'-o','color','g','linewidth',3,...
                    'MarkerEdgeColor','k','MarkerFaceColor','b','MarkerSize',2)
                else
